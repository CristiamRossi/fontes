...
While TMP->(!Eof())
   ...
   //posiciona no pedido da da nota
	...
	nQtdItens := 0
	dbSelectArea("SD2")
	While SD2->(!Eof()) .And. SD2->(D2_FILIAL+D2_DOC+D2_SERIE+D2_CLIENTE+D2_LOJA) == TMP->(F2_FILIAL+F2_DOC+F2_SERIE+F2_CLIENTE+F2_LOJA)
...
If Empty(SB1->B1_CODBAR)
	cTXT +=	PadL(SubStr(AllTrim(SB1->B1_XCODDUN),1,14),14,"0") 
Else
...
cTXT += PadL(AllTrim(TransForm(SD2->D2_ICMSRET*100	,"@E 99999999999")),15,"0") 
cTXT += PadL(AllTrim(SB1->B1_POSIPI),08,"0")
cTXT += Replicate(" ",02)
cTXT += PadL(AllTrim(SF4->F4_SITTRIB),02,"0") 
...
cTXT += PadL(AllTrim(TransForm(,			,"@E 9999999999")),10,"0") 	 	//quantidade de itens
...
�����������������������������������������������������������������������������
�������������������������������������������������������������������������ͻ��
���Programa  �FimArq    �Autor  �Stanko              � Data �  13/08/08   ���
�������������������������������������������������������������������������͹��
���Desc.     � FimArq 			                                          ���
���          �                                                            ���
�������������������������������������������������������������������������͹��
...
�����������������������������������������������������������������������������
�������������������������������������������������������������������������ͻ��
���Programa  �Ponto     �Autor  �Stanko              � Data �  13/08/08   ���
�������������������������������������������������������������������������͹��
���Desc.     � Funcao para trocar a virgula por ponto                     ���
���          �                                                            ���
�������������������������������������������������������������������������͹��
���Uso       � FATURAMENTO - Especifico                                   ���
�������������������������������������������������������������������������ͼ��
