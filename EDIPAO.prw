...
�����������������������������������������������������������������������������
�������������������������������������������������������������������������ͻ��
���Programa  � �Autor  �Elvis Kinuta                 � Data �  06/03/20   ���
�������������������������������������������������������������������������͹��
���Desc.     � Exporta um arquivo texto de notas fiscais de saida.        ���
���          �                                                            ���
�������������������������������������������������������������������������͹��
���Uso       � EDI Pao de a�ucar                           ���
�������������������������������������������������������������������������ͼ��
�����������������������������������������������������������������������������
�����������������������������������������������������������������������������
*/
...
Private  cTitulo := "EDI NF Sa�da - P�o de A��car"
...
If Pergunte(cPerg,.T.)
	...
	if ( nHandle := FCreate(cNome,0) ) == -1
          msgAlert( "Falha na cria��o do arquivo: "+cNome, cTitulo )
          return 
     endif
...
�����������������������������������������������������������������������������
�������������������������������������������������������������������������ͻ��
���Programa  �GERATXTNF �Autor  �Microsiga           � Data �  03/06/20   ���
�������������������������������������������������������������������������͹��
���Desc.     �  PROCESSAMENTO                                             ���
���          �                                                            ���
�������������������������������������������������������������������������͹��
...
if ! SA1->( dbSeek( xFilial("SA1") + SM0->M0_CGC) )
     msgAlert( "N�o encontrado cliente (SA1) com o CNPJ: "+SM0->M0_CGC, cTitulo)
     return .F.
endif

if empty( SA1->A1_XEANPAO )
     msgAlert( "N�o cadastrado o EAN P�o do cliente "+ SA1->A1_COD, cTitulo)
     return .F.
endif

if empty( SA1->A1_BCO1 )
     msgAlert( "N�o cadastrado o banco no cliente "+ SA1->A1_COD, cTitulo)
     return .F.
endif

SA6->( dbSetOrder(1) )
if ! SA6->( dbSeek( xFilial("SA6") + SA1->A1_BCO1 ) )
     msgAlert( "N�o encontrado o banco (SA6) c�digo: "+SA1->A1_BCO1, cTitulo)
     return .F.
endif
...
While TMP->(!Eof())
	...
	dbSelectArea("SD2")
	SD2->(dbSetOrder(3))
	SD2->(dbSeek(TMP->(F2_FILIAL+F2_DOC+F2_SERIE+F2_CLIENTE+F2_LOJA)))
...
cTXT += SF2->F2_DOC																									
cTXT += SF2->F2_SERIE																								
//cTXT += DtoS(SF2->F2_EMISSAO)+SubStr(Time(),1,2)+SubStr(Time(),4,2)
...
cTXT += PadL(AllTrim(TMP->A1_XEANPAO),13,"0") // 101-113     EAN COMPRADOR      <- Cristiam 23/02/2020
...
cTXT += PadL(AllTrim(TMP->A1_XEANPAO),13,"0") // 177-189     loc COBRAN�A-EAN COMPRADOR
...
//REGISTRO DE CONDI��ES DE PAGAMENTO           
...
�����������������������������������������������������������������������������
�������������������������������������������������������������������������ͻ��
���Programa  �EDIPAO    �Autor  �Microsiga           � Data �  03/06/20   ���
�������������������������������������������������������������������������͹��
���Desc.     �  ITENS                                                     ���
���          �                                                            ���
�������������������������������������������������������������������������͹��
...
EndIf
cTXT += Replicate("0",10)
cTXT += PadL(strTran(cValToChar(SD2->D2_QUANT),".",""),10,"0")	// 38-48
cTXT += PadR(AllTrim(SD2->D2_UM),03," ")                         // 49-51
cTXT += PadL(strTran(cValToChar(SD2->D2_QUANT),".",""),10,"0")	// 52-61
cTXT += PadR(AllTrim(SD2->D2_UM),03," ")                         // 62-64
cTXT += Replicate("0",08)
cTXT += PadL(strTran(cValToChar(SD2->D2_TOTAL) ,".",""),15,"0") 			//73-87
cTXT += PadL(strTran(cValToChar(SD2->D2_TOTAL) ,".",""),15,"0") 
cTXT += PadL(strTran(cValToChar(SD2->D2_PRCVEN),".",""),13,"0")
cTXT += PadL(strTran(cValToChar(SD2->D2_PRCVEN),".",""),13,"0")
...
cTXT += Replicate("0",13)
cTXT += Replicate("0",05) 
cTXT += PadL(strTran(cValToChar(SD2->D2_BASEICM),".",""),15,"0") 			//169-183
cTXT += PadL(strTran(cValToChar(SD2->D2_VALICM) ,".",""),15,"0")
cTXT += PadL(strTran(cValToChar(SD2->D2_BRICMS) ,".",""),15,"0")
cTXT += PadL(strTran(cValToChar(SD2->D2_ICMSRET),".",""),15,"0")
...
�����������������������������������������������������������������������������
�������������������������������������������������������������������������ͻ��
���Programa  �FimNF     �Autor  �Stanko              � Data �  13/08/08   ���
�������������������������������������������������������������������������͹��
���Desc.     � FimNF 			                                          ���
���          �                                                            ���
�������������������������������������������������������������������������͹��
���Uso       � FATURAMENTO - Especifico                                   ���
�������������������������������������������������������������������������ͼ��
�����������������������������������������������������������������������������
�����������������������������������������������������������������������������
*/
